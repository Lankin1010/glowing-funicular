...
void showPostTimerMenu() {
  ...
  lcdUpdateLine(1, "3:Rewd 4:Reset");
}
...
void loop() {
  ...
  // Handle debug toggle (button 4 hold for 3s)
  if (btn4) {
    if (!button4Held) {
